...
class ClaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return back()->withErrors(['error' => 'Error al crear clase: ' . $e->getMessage()])->withInput();
        }
    }
    ...
    public function update(Request $request, Clase $clase)
    {
        try {
            ...
            if (!empty($alumnos)) {
                ...
                $clase->alumnos()->detach();
            }

            return redirect()->route('admin.clases.index')
                ->with('success', 'Clase actualizada exitosamente.');
        } catch (\Exception $e) {
            return back()->withErrors(['error' => 'Error al actualizar clase: ' . $e->getMessage()])->withInput();
        }
    }
