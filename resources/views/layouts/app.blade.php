...
<head>
    ...
    <title>@yield('title', 'DreamSound Academy')</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('dashboard') }}">
                <img src="{{ asset('images/logo.png') }}" alt="DreamSound Academy" height="40" class="me-2" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('admin.alumnos.index') }}">
                                <i class="bi bi-person-badge"></i> Alumnos
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.instrumentos.index') }}">
                                <i class="bi bi-music-note-list"></i> Instrumentos
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.clases.index') }}">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            ...
                            <span class="badge bg-warning text-dark ms-1">{{ ucfirst(auth()->user()->role->name) }}</span>
                        </a>
