        ...
        <div class="stats-card" style="background: linear-gradient(135deg, #2e7d32 0%, #4caf50 100%);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0">{{ $stats['alumnos'] }}</h2>
                </div>
        ...
        <div class="stats-card" style="background: linear-gradient(135deg, #0288d1 0%, #03a9f4 100%);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0">{{ $stats['instrumentos'] }}</h2>
                </div>
...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.alumnos.index') }}" class="btn btn-success">
                        <i class="bi bi-person-badge"></i> Gestionar Alumnos
                    </a>
                    <a href="{{ route('admin.instrumentos.index') }}" class="btn btn-info">
                        <i class="bi bi-music-note-list"></i> Gestionar Instrumentos
                    </a>
                    <a href="{{ route('admin.clases.index') }}" class="btn btn-warning">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-2"><strong>Rol:</strong> <span class="badge bg-primary">{{ ucfirst(auth()->user()->role->name) }}</span></p>
